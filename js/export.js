                ...
                function(transaction, results) {
                    ...
                    $.ajax({
                        ...
                        .always(function(data, status, jqXHR){
                            // Switch anhand Result: pushToServer <-> pullToClient
...
function pushToServer(server_stamp) {
console.log("pushing...");
    ...
    if (navigator.onLine){
        ...
        if (window.confirm('Du bist online.\nSoll die Klasse auch auf dem SyncServer gelöscht werden ?')){
            ...
            $.ajax({
                ...
                }).done(function(){console.log(syncResult);});
            }else{
...
function export_to_pdf_old () {
    ...
    doc.text(25,25,"Funktion wird noch entwickelt");
    doc.setFontSize('12');
    doc.text(25,80,"Die Leistungen der Klasse werden hier aufgelistet");
    var this_El = document.getElementById('export_to_pdf');
    this_El.href += "#"+doc.output('datauristring');
}
